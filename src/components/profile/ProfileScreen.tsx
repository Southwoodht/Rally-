...
export function ProfileScreen({ players, meId, shared, onSetMe, goH2H, goSettings, goEdit, goFriends, goQuality, goHistory }: any) {
  ...
  return (
    <ProfileContainer
      ...
      onStyleDetails={goQuality}
      onAllHistory={goHistory}
    />
  );
}
