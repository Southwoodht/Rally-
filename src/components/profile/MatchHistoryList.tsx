...
import { FEED_DRAW, FEED_LIME, FEED_LOSS, FEED_TEXT_HI, FEED_TEXT_MID, body, tabular } from "@/lib/theme";
      ...
      {items.map((m, i) => (
        <div
          ...
          style={{
            ...
            borderLeft: "3px solid " + BORDER[m.outcome],
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: body, fontSize: 15, color: FEED_TEXT_HI, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              <span style={{ fontWeight: 500 }}>{VERB[m.outcome]}</span> {m.opponent}
            </div>
            {m.pending && (
